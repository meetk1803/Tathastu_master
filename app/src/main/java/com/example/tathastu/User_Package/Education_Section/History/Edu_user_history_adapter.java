...
import com.example.tathastu.User_Package.Food_Section.History.Food_user_history_edit_request;
...
public class Edu_user_history_adapter extends RecyclerView.Adapter<Edu_user_history_adapter.ViewHolder> {
    ...
    Edu_user_history_adapter(Edu_user_History context, ArrayList<String> name, ArrayList<String> type, ArrayList<String> mno, ArrayList<String> loc) {
    ...
    @NonNull
    @Override
    public Edu_user_history_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = layoutInflater.inflate(R.layout.cardview_user_edu_request, viewGroup, false);
        return new Edu_user_history_adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Edu_user_history_adapter.ViewHolder viewHolder, int i) {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            BTN_edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent i = new Intent(view.getContext(), Edu_user_history_edit_request.class);
