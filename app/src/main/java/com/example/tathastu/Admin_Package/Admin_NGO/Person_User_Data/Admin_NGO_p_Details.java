...
public class Admin_NGO_p_Details extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Admin_NGO_p_DataModel> userDataModelList = generateDummyData();
        ...
        List<Admin_NGO_p_History_DataModel> userHistoryDataModelList = generateDummyDataHistory();
...
//--------------------------------------------------------------------------------------------------
    ...
    private List<Admin_NGO_p_DataModel> generateDummyData() {
        // Replace this method with your actual data retrieval logic
        List<Admin_NGO_p_DataModel> dummyData = new ArrayList<>();
        ...
        for (int i = 0; i < 1; i++) { // Change 5 to the number of items you want
            ...
            Admin_NGO_p_DataModel userModel = new Admin_NGO_p_DataModel(userName,userNumber,userEmail,userDob);
    ...
    private List<Admin_NGO_p_History_DataModel> generateDummyDataHistory() {
        // Replace this method with your actual data retrieval logic
        List<Admin_NGO_p_History_DataModel> dummyHistoryData = new ArrayList<>();

        // Add dummy data with alternating banner images
        for (int i = 0; i < 10; i++) { // Change 5 to the number of items you want
            String campName="donated from,\nABC AAAAAAAA";
            String moneyPayment="12000";
            String Dob="12/12/2003";

            Admin_NGO_p_History_DataModel userHistoryModel = new Admin_NGO_p_History_DataModel(campName,moneyPayment,Dob);
