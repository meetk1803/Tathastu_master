...
public class Admin_NGO_Data extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Admin_NGO_DataModel> userDataModelList = generateDummyData();
...
//--------------------------------------------------------------------------------------------------
    ...
    private List<Admin_NGO_DataModel> generateDummyData() {
        List<Admin_NGO_DataModel> dummyData = new ArrayList<>();
        for (int i = 0; i < 10; i++) {
            String userName = "Fname Lname"+i;
            String userNumber = "+91 1234567890";
            String userEmail = "tathastu052threesofficial@gmail.com";
            Admin_NGO_DataModel userModel = new Admin_NGO_DataModel(userName, userNumber, userEmail);
